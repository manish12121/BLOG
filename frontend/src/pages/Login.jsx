      ...
      <div className='flex justify-center items-center flex-1 px-4 md:px-0'>
        <Card className="w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600">
          ...
          <form className='space-y-4' onSubmit={handleSubmit}>
            ...
            <p className='text-center text-gray-600 dark:text-gray-300'>Don't have an account? <Link to={'/signup'}><span className='underline curser-pointer hover:text-gray-800 dark:hover:text-gray-100'>signup</span></Link></p>
          </form>
        </Card>
      </div>
    </div>
